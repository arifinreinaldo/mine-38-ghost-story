...
export const cases = { mahameru, kencana, mutiara, garut, anggrek, tjandi, upacara, sumur, toraja, banten }
export const caseList = [mahameru, kencana, mutiara, garut, anggrek, tjandi, upacara, sumur, toraja, banten]
